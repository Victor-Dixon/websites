# UTM Tracking Guide - freerideinvestor.com
...
- `utm_campaign`: Campaign identifier ("trading_roadmap", "premium_upsell", "trading_content", etc.)
...
```
https://freerideinvestor.com/lead-magnet/?utm_source=instagram&utm_medium=bio&utm_campaign=trading_roadmap
```

### Email Newsletter → Homepage:
```
https://freerideinvestor.com/?utm_source=email&utm_medium=newsletter&utm_campaign=trading_roadmap
```

### Facebook Ad → Contact:
```
https://freerideinvestor.com/contact/?utm_source=facebook&utm_medium=cpc&utm_campaign=trading_roadmap&utm_content=ad_01
```
