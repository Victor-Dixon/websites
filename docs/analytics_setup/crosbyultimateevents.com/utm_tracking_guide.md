# UTM Tracking Guide - crosbyultimateevents.com
...
- `utm_campaign`: Campaign identifier ("leadmagnet_checklist", "home_abtest_A", "holiday_events", "corporate_q1", etc.)
...
```
https://crosbyultimateevents.com/lead-magnet/?utm_source=instagram&utm_medium=bio&utm_campaign=leadmagnet_checklist
```

### Email Newsletter → Homepage:
```
https://crosbyultimateevents.com/?utm_source=email&utm_medium=newsletter&utm_campaign=leadmagnet_checklist
```

### Facebook Ad → Contact:
```
https://crosbyultimateevents.com/contact/?utm_source=facebook&utm_medium=cpc&utm_campaign=leadmagnet_checklist&utm_content=ad_01
```
