...
function freerideinvestor_scripts() {
    // Theme stylesheet - remove version for cache busting
    wp_enqueue_style('freerideinvestor-style', get_stylesheet_uri(), array(), null);
    ...
    // Tailwind CSS - defer loading for better performance
    wp_enqueue_style('tailwind-css', 'https://cdn.tailwindcss.com', array(), null);

    // Theme JavaScript - defer loading
    wp_enqueue_script('freerideinvestor-script', get_template_directory_uri() . '/js/theme.js', array('jquery'), null, true);
