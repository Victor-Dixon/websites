# Verify client hardening inline live

Generated: 2026-06-05T06:41:40-05:00

## Page version

```text
emergence-cg.css?ver=0.7.9-client-hardening-answers-001
emergence-character-generator.css?ver=0.7.9-client-hardening-answers-001
EmergenceCG
EmergenceCG
EmergenceCG
EmergenceCG
question_bank
emergence-cg.js?ver=0.7.9-client-hardening-answers-001
emergence-character-generator.js?ver=0.7.9-client-hardening-answers-001
```
...
```text
--- page inline ---
1832:            /* DreamOS client hardening allowlist: public Spark payload keys */
1834:            throw new Error('Unsafe public demo hardening payload blocked: ' + key);
--- emergence-cg.js ---
...
date: Fri, 05 Jun 2026 11:41:41 GMT
server: LiteSpeed
platform: hostinger
panel: hpanel
...
The 0.7.9 client hardening patch is live and answers payload is accepted by the Spark generator endpoint.
