# Select WeAreSwarm Live Upload Method 001

- Generated: `2026-06-03T17:24:25`
- Status: `METHOD_SELECTED`
- Method: `ssh_scp_or_sftp`
- Reason: scp/sftp tools are available; use route-only upload after identifying host/path env
...
- Guardrail: Upload route file only. Do not overwrite public root or homepage.
