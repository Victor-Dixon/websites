# WeAreSwarm SFTP Target Candidates 001

- Generated: `2026-06-03T17:27:15`
- Status: `TARGET_CANDIDATES_EXTRACTED`
- Candidate count: `45`
- Top count: `12`
- Artifact: `_deploy/weareswarm/dreamos-services/index.html`
- Desired remote file: `/dreamos-services/index.html`

## Guardrail

No upload performed. Do not overwrite public root or homepage.

## Top Candidates

### 1. `_reports/hostinger_access_preflight_002b.md`
- Score: `31`
- Reasons: `weareswarm, public_html, domains, hostinger, deploy, ssh`
- Possible paths:
  - `/home/u996867598/domain`
  - `public_html`
- Sample lines:
...
- Score: `28`
- Reasons: `weareswarm, public_html, domains, hostinger, deploy`
- Possible paths:
  - `/home/project`
  - `/home/u996867598/domain`
  - `public_html`
  - `public_html	0	0	0	0	1	1`
  - `public_html	1	1	1	1	0	1`
  - `public_html	1	1	1	1	1	1`
  - `public_html/data/t`
  - `public_html/t`
- Sample lines:
...
### 3. `_reports/hostinger_deploy_target_guard_001.txt`
- Score: `28`
- Reasons: `weareswarm, public_html, domains, hostinger, deploy`
- Possible paths:
  - `/home/u996867598/domain`
...
### 4. `_reports/hostinger_access_preflight_002b.txt`
- Score: `25`
- Reasons: `weareswarm, public_html, domains, hostinger`
- Possible paths:
  - `/home/u996867598/domain`
  - `public_html`
- Sample lines:
...
### 5. `_reports/hostinger_custom_asset_candidates_045.txt`
- Score: `25`
- Reasons: `weareswarm, public_html, domains, hostinger`
- Possible paths:
  - `/home/u996867598/domain`
...
### 6. `_reports/hostinger_custom_asset_collection_045.md`
- Score: `25`
- Reasons: `weareswarm, public_html, domains, hostinger`
- Possible paths:
  - `/home/u996867598/domain`
...
### 7. `_reports/website_audit/http_500_root_causes/weareswarm.online__500_root_cause.md`
- Score: `25`
- Reasons: `weareswarm, public_html, domains, hostinger`
- Possible paths:
  - `/home/u996867598/domain`
...
### 8. `_reports/website_audit/http_500_root_causes/weareswarm.online__remote_500_audit.txt`
- Score: `25`
- Reasons: `weareswarm, public_html, domains, hostinger`
- Possible paths:
  - `/home/u996867598/domain`
...
### 9. `_reports/website_audit/http_500_root_causes/weareswarm.site__500_root_cause.md`
- Score: `25`
- Reasons: `weareswarm, public_html, domains, hostinger`
- Possible paths:
  - `/home/u996867598/domain`
...
### 10. `_reports/website_audit/http_500_root_causes/weareswarm.site__remote_500_audit.txt`
- Score: `25`
- Reasons: `weareswarm, public_html, domains, hostinger`
- Possible paths:
  - `/home/u996867598/domain`
...
### 11. `_reports/website_audit/weareswarm.online__audit.md`
- Score: `25`
- Reasons: `weareswarm, public_html, domains, hostinger`
- Possible paths:
  - `/home/u996867598/domain`
...
### 12. `_reports/website_audit/weareswarm.site__audit.md`
- Score: `25`
- Reasons: `weareswarm, public_html, domains, hostinger`
- Possible paths:
  - `/home/u996867598/domain`
...
- TARGET: confirm exact WeAreSwarm remote root
- ACTION: inspect top candidate config/manifest lines and confirm remote domain root before upload
- VERIFY: one selected remote root plus route-only target path
- COMMIT: Document WeAreSwarm SFTP target
