#!/usr/bin/env python3
"""Deploy updated functions.php for dadudekc.com"""
...
local_file = Path("D:/websites/sites/dadudekc.com/wp/theme/dadudekc/functions.php").resolve()
remote_file = f"/home/{username}/domains/dadudekc.com/public_html/wp-content/themes/dadudekc/functions.php"
...
try:
    ...
    print("✅ Deployed updated functions.php")
