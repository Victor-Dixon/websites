...
$subview = (!empty(isset($_GET['subview']) ? sanitize_text_field($_GET['subview']) : '') && in_array(isset($_GET['subview']) ? sanitize_text_field($_GET['subview']) : '', $allowedSubviews)) ? isset($_GET['subview']) ? sanitize_text_field($_GET['subview']) : '' : 'general';
