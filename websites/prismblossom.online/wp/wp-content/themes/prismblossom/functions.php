...
function prismblossomonline_enqueue_ai_context_scripts() {
    // Enqueue AI Context Integration for hero personalization
    wp_enqueue_script(
        'ai-context-hero-integration',
        get_template_directory_uri() . '/js/ai-context-hero-integration.js',
        array(),
        '1.0.0',
        true
    );
    ...
    wp_localize_script('ai-context-hero-integration', 'AIContextConfig', array(
        'heroType' => 'business',
        'websocketUrl' => 'ws://localhost:8080/ai-context',
        'apiEndpoint' => '/wp-json/prismblossom/v1/ai-context'
    ));
}
add_action('wp_enqueue_scripts', 'prismblossomonline_enqueue_ai_context_scripts');
