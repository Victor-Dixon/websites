...
function ariajetsite_enqueue_ai_context_scripts() {
    ...
    wp_localize_script('ai-context-hero-integration', 'AIContextConfig', array(
        ...
        'apiEndpoint' => '/wp-json/ariajet/v1/ai-context'
    ));
}
add_action('wp_enqueue_scripts', 'ariajetsite_enqueue_ai_context_scripts');
