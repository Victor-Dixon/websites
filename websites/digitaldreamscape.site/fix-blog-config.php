<?php
/**
 * Fix Blog Configuration - Web Accessible Script
 * Access at: https://digitaldreamscape.site/fix-blog-config.php
 */
...
if (!isset($_SERVER['REMOTE_ADDR']) || $_SERVER['REMOTE_ADDR'] === '127.0.0.1' || $_SERVER['REMOTE_ADDR'] === '::1') {
    ...
    echo "<p><a href='/blog/'>Visit the blog</a> to see your episodes.</p>\n";
