<?php
function digital_dreamscape_enqueue_styles() {
    wp_enqueue_style('digital-dreamscape-style', get_stylesheet_uri());

    // Tailwind CSS for Hero Animations
    wp_enqueue_style('tailwind-css', 'https://cdn.tailwindcss.com', array(), null);
}
add_action('wp_enqueue_scripts', 'digital_dreamscape_enqueue_styles');
