...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 swarm-gradient">
    ...
    <div class="absolute bottom-32 left-10 right-10 opacity-20">
        <svg viewBox="0 0 800 60" class="w-full h-12">
            ...
            <line x1="100" y1="30" x2="200" y2="20" stroke="#a855f7" stroke-width="0.5" class="swarm-connect"/>
            <line x1="200" y1="20" x2="300" y2="40" stroke="#06b6d4" stroke-width="0.5" class="swarm-connect" style="animation-delay: 0.5s;"/>
            <line x1="300" y1="40" x2="400" y2="10" stroke="#f59e0b" stroke-width="0.5" class="swarm-connect" style="animation-delay: 1s;"/>
            <line x1="400" y1="10" x2="500" y2="35" stroke="#a855f7" stroke-width="0.5" class="swarm-connect" style="animation-delay: 1.5s;"/>
            <line x1="500" y1="35" x2="600" y2="15" stroke="#06b6d4" stroke-width="0.5" class="swarm-connect" style="animation-delay: 2s;"/>
            <line x1="600" y1="15" x2="700" y2="30" stroke="#f59e0b" stroke-width="0.5" class="swarm-connect" style="animation-delay: 2.5s;"/>
