    ...
    <section class="icp-definition-section">
        <div class="container">
            <div class="icp-definition icp-card">
                <h3 class="icp-heading"><?php esc_html_e('Ideal Customer Profile', 'crosbyultimateevents'); ?></h3>
                <div class="icp-content">
                    <p class="icp-text">
                        <?php 
                        printf(
                            esc_html__('For %s who %s, we create unforgettable events.', 'crosbyultimateevents'),
                    ...
                    <p class="outcome-text">
                        <strong><?php esc_html_e('Your outcome:', 'crosbyultimateevents'); ?></strong> <?php echo esc_html($outcomes); ?>
                    </p>
                </div>
            </div>
        </div>
