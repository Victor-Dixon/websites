...
<div class="ssp-showcase-container">
    ...
    <section id="features" class="ssp-features">
        ...
        <div class="ssp-features-grid">
            <div class="ssp-feature-item">
                ...
                <!-- Optional: Insert a reference to the plugin's stock research shortcode -->
                <p><em>Try it out:</em> <code>[stock_research]</code></p>
            </div>
            <div class="ssp-feature-item">
            ...
            <div class="ssp-feature-item">
                ...
                <!-- Optional: Insert a reference to the plugin's alert setup shortcode -->
                <p><em>Try it out:</em> <code>[alert_setup]</code></p>
            </div>
            <div class="ssp-feature-item">
    ...
    <section class="ssp-stock-insights">
        ...
        <div id="ssp-live-stocks" class="ssp-live-stocks">
            <!-- We'll replace this placeholder with actual data via AJAX or shortcodes. -->
            <p>Loading stock insights...</p>
        </div>
        <!-- Example: Use a custom JS snippet or a plugin shortcode to fetch & display data. -->
        <!-- <p><em>Try it out:</em> <code>[stock_research symbols="AAPL, TSLA"]</code></p> -->
    </section>
