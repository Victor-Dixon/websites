...
Kudos to [patchstack](https://patchstack.com/database/vulnerability/stock-ticker) and [Wordfence Intelligence](https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/stock-ticker) researchers for early reporting vulnerabilities!
