...
class NextendSocialProviderTwitterClient extends NextendSocialAuth {
    ...
    public function checkError() {
        if (isset(isset($_GET['denied']) ? sanitize_text_field($_GET['denied']) : '')) {
            throw new Exception('Authentication cancelled');
        }
    }

    public function hasAuthenticateData() {
        return isset(isset($_REQUEST['oauth_token']) ? sanitize_text_field($_REQUEST['oauth_token']) : '') && isset(isset($_REQUEST['oauth_verifier']) ? sanitize_text_field($_REQUEST['oauth_verifier']) : '');
    }
