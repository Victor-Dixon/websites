...
function add_meta_description() {
    $description = "Trading Robot Plug - Automated trading robots that actually work. Join the waitlist for performance-tracked trading automation with proven results.";
...
function set_seo_title($title) {
    $site_title = "Trading Robot Plug - Automated Trading Robots That Actually Work";
...
add_filter('document_title_parts', function($title_parts) {
    $title_parts['title'] = "Trading Robot Plug - Automated Trading Robots That Actually Work";
    return $title_parts;
}, 10, 1);
