...
function add_meta_description() {
    $description = "Prism Blossom - Discover unique digital experiences and creative content. Your destination for innovative online experiences.";
...
function set_seo_title($title) {
    $site_title = "Prism Blossom - Unique Digital Experiences & Creative Content";
...
add_filter('document_title_parts', function($title_parts) {
    $title_parts['title'] = "Prism Blossom - Unique Digital Experiences & Creative Content";
    return $title_parts;
}, 10, 1);
