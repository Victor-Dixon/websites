 ...
 * Version: 0.7.7-floating-dossier-fab-001
 * Author: Dream.OS
 */
...
function emergence_cg_register_assets() {
    wp_register_style('emergence-cg-style', plugins_url('assets/emergence-cg.css', __FILE__), array(), '0.7.7-floating-dossier-fab-001');
    wp_register_script('emergence-cg-script', plugins_url('assets/emergence-cg.js', __FILE__), array(), '0.7.7-floating-dossier-fab-001', true);
...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('emergence-cg-public', $base . 'emergence-character-generator.css', array(), '0.7.7-floating-dossier-fab-001');
    wp_enqueue_script('emergence-cg-public', $base . 'emergence-character-generator.js', array(), '0.7.7-floating-dossier-fab-001', true);
});
