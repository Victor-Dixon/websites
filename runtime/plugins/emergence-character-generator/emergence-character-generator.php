 ...
 * Version: 0.8.3-dossier-end-only-001
 * Author: Dream.OS
 */
...
function emergence_cg_register_assets() {
    wp_register_style('emergence-cg-style', plugins_url('assets/emergence-cg.css', __FILE__), array(), '0.8.3-dossier-end-only-001');
    wp_register_script('emergence-cg-script', plugins_url('assets/emergence-cg.js', __FILE__), array(), '0.8.3-dossier-end-only-001', true);
...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('emergence-cg-public', $base . 'emergence-character-generator.css', array(), '0.8.3-dossier-end-only-001');
    wp_enqueue_script('emergence-cg-public', $base . 'emergence-character-generator.js', array(), '0.8.3-dossier-end-only-001', true);
});
