(function () {
  ...
  function renderMissions() {
    ...
    grid.innerHTML =
      ...
      missionCard("Meridian Dispatch", "Active", "Pick a mission seed and carry your Spark into the city.", "/missions/") +
      missionCard("What-If Arena", "Optional", "Test matchups and battle conditions after your Spark is created.", "/battles/");
  }
  ...
  function applySession(loggedIn, user) {
    ...
    setText(
      "dash-lede",
      loggedIn
        ? "Your restored Spark Command Post is online."
