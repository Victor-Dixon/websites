# Emergence Battle Story Cinematics 106b

## Task
Improve battle result output so arena/winner/story reads cinematic and character-specific.

## Actions
- Added cinematic arena/detail selector.
- Added role and ability showcase derivation.
- Replaced generic custom battle story with multi-beat cinematic story.
- Preserved player-safe output and hidden backend math.
- Re-ran existing token/record/full handoff smokes.

## Verification
```text
INPUTS=PASS
BATTLE_STORY_CINEMATICS_PATCH=PASS
STATIC_CINEMATIC_STORY_SAFE=PASS
PLUGIN_TARBALL=PASS /data/data/com.termux/files/home/projects/websites/_reports/spark-battle-sim_106b.tar.gz
SCP_UPLOAD=PASS
...
REMOTE_DEPLOY=PASS
HTTP_CUSTOM_BATTLE=200
CINEMATIC_CUSTOM_BATTLE=PASS
CINEMATIC_STORY_RICHNESS=PASS
CINEMATIC_STORY_CHARACTER_SPECIFIC=PASS
CINEMATIC_STORY_NO_RAW_SCORE_LEAK=PASS
== SAFE PAYLOAD ASSERT ==
...
EXISTING_HANDOFF_SMOKES=PASS
```

## Commit
Improve Emergence battle story cinematics
