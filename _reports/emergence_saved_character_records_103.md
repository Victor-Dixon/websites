# Emergence Saved Character Records 103

## Task
Persist generated Spark dossiers as saved public/private character records.

## Actions
- Added character save/load REST routes.
- Added record → battle token route.
- Added private/public visibility field.
- Added Character Generator save button bridge.
- Added Battle Simulator character_record import bridge.
...
```text
INPUTS=PASS
SAVED_CHARACTER_RECORDS_PATCH=PASS
STATIC_RECORD_SECURITY=PASS
STATIC_RECORD_NO_RAW_SCORE_EXPORT=PASS
...
SAVED_CHARACTER_RECORDS=PASS
```

## Commit
Add Emergence saved character records
